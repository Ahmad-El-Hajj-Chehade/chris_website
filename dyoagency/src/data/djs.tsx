export const djs = [
  ...
  },
  {
    id: "regina-brury",
    name: "REGINA BRURY",
    shortBio: "Romantic Acoustic Pop",
    image: "/regina-brury.png", 
    fullBio: `
          Brazilian-born and Zurich-based, 
          Regina Brury 
          is a romantic singer-songwriter blending Brazilian emotional intensity with internationally accessible acoustic pop.
          After rebuilding her career from zero in Switzerland, she achieved Swiss radio rotation on stations such as 
          Radio Grischa, Radio Südostschweiz, and Kanal K. 
          In 2025, she performed at renowned venues including 
          Papiersaal and X-TRA.
          Her personal audience grew organically to over 
           13,000 followers within just 15 months, with the majority based in Switzerland and Europe. 
          With her debut solo single "3 Big Words", she returns to her essence: 
          voice and acoustic guitar in their purest form.     
          Regina's journey is one of resilience. From performing in Brazil at the age of twelve to starting over in Switzerland, 
          her solo project stands for refinement and clarity. She delivers a romantic acoustic voice that carries 
          both passion and maturity. 
    `,
